...
1. **Download the Plugin**: Go to the [Releases](https://github.com/PullsarDev/BrightEyePrivate/releases) page and download the binary ZIP file for your Unreal Engine version from the **Assets** section at the bottom of the page.
